  ...
  handleLikeClick(clickEvent) {
    ...
    if (clickEvent.button === 0) {
      ...
      if (this.didUserLike()) {
        ...
        unlikeComment(this.props.fid, 4, this.props.commentIndex, callbackFunction);
      } else {
        // User clicked 'like' button.
        likeComment(this.props.fid, 4, this.props.commentIndex, callbackFunction);
      }
    }
  }
    ...
    return (
      <div>
        ...
        <div className="media-body">
          ...
          <br /><a href="#" onClick={(e) => this.handleLikeClick(e)}> {likeButtonText} {this.props.likeCounter.length}</a> · <a href="#">Reply</a> ·
